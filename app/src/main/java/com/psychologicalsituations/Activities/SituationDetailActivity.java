...
public class SituationDetailActivity extends AppCompatActivity implements SituationDetailClickListener {
    ...
    private void populateDetails(Intent data) {
        details.add(data.getStringExtra(getString(R.string.situation)));
        details.add(data.getStringExtra(getString(R.string.idea)));
        details.add(data.getStringExtra(getString(R.string.emotion)));
        details.add(data.getStringExtra(getString(R.string.behaviour)));
        details.add(data.getStringExtra(getString(R.string.wrong_thinking)));
        details.add(data.getStringExtra(getString(R.string.coent)));
        details.add(data.getStringExtra(getString(R.string.ceontP)));
